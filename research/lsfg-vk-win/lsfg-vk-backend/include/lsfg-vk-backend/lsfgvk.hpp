...
#include "lsfg-vk-common/helpers/export.hpp"
...
namespace lsfgvk::backend {
    ...
    class LSFGVK_PUBLIC ContextImpl;
    class LSFGVK_PUBLIC InstanceImpl;
    ...
    ///
    class LSFGVK_PUBLIC error : public std::runtime_error {
    public:
        ///
        /// Construct an error
        ///
    ...
    public:
        ...
        /// is ready, signal the synchronization handle with one increment (with the first trigger being 1).
        ...
        ///
        /// @param sourceHandles Pair of external handles for the source images alternated between.
        /// @param destHandles Vector with external handles to import output images from.
        /// @param syncHandle External handle for the timeline semaphore used for synchronization.
